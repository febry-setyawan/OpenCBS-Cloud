...
public class AuditEventsReport implements AuditReport {
    ...
    public Page getRecords(AuditReportDto filter, Pageable pageable) {
        ...
        int fromPosition = (eventIds.size() < (int)pageable(int).getOffset()) ? eventIds.size() : (int)pageable(int).getOffset();
        int toPosition = (eventIds.size() > (int)pageable(int).getOffset() + pageable(int).getPageSize()) ? (int)pageable(int).getOffset() + pageable(int).getPageSize() : eventIds.size();
