...
ALTER TABLE loan_products ADD COLUMN IF NOT EXISTS code varchar(32) unique;
...
ALTER TABLE loans ADD COLUMN IF NOT EXISTS code varchar(100);
...
ALTER TABLE loan_applications ADD COLUMN IF NOT EXISTS code varchar(100);
